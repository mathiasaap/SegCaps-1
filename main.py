...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss', type=str.lower, default='multi_dice', choices=['bce', 'w_bce', 'dice', 'mar', 'w_mar', 'multi_dice', 'multi_spread'],
    ...
    parser.add_argument('--adam_b1', type=float, default=0.99,
                        help='Adam beta1 decay.')
    parser.add_argument('--recon_wei', type=float, default=0.9,
    ...
    parser.add_argument('--dataset', type=str.lower, default='brats', choices=['brats', 'luna16', 'heart', 'spleen', 'colon', 'hepatic', 'pancreas', 'hippocampus', 'liver',],
